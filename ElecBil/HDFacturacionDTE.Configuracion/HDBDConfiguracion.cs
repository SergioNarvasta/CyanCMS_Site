...
{
    public class HDBDConfiguracion : IHDBDConfiguracion
    {
        ...
        public string CadenaConexion
        {
            get
            {
                ...
                {
                    //cadena = "User Id=" + ((Usuario == null) ? string.Empty : Usuario) + ";Data Source=" + ((Servidor == null) ? string.Empty : Servidor) + ((Port == null) ? string.Empty : "," + Port + ";Network Library=DBMSSOCN") + ";password=" + ((Password == null) ? string.Empty : Password) + ";Initial Catalog=" + ((BaseDatos == null) ? string.Empty : BaseDatos);
